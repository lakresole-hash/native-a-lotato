package com.smartxplorer.bestsystemlottery.connectionInternet;
...
//    }
    ...
    public static boolean isConnected(Context context) {
        NetworkInfo info = UtilNetwork.getNetworkInfo(context);
    ...
    public static boolean isConnectedFast(Context context) {
        NetworkInfo info = UtilNetwork.getNetworkInfo(context);
        return (info != null && info.isConnected() && UtilNetwork.isConnectionFast(info.getType(), info.getSubtype(),
                context));
    }
    ...
    public static boolean isConnectionFast(int type, int subType, Context context) {
        if (type == ConnectivityManager.TYPE_WIFI) {
            ...
            Log.e("Speed: ", "" + wifiInfo.getLinkSpeed());
            return true;
