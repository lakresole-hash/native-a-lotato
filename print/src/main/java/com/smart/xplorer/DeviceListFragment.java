...
public class DeviceListFragment extends DialogFragment {
    ...
    private SmartPrinter.OnConnectPrinter onConnectPrinter;
    ...
    public void setOnConnectPrinter(SmartPrinter.OnConnectPrinter onConnectPrinter) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btClose.setOnClickListener(v -> close());
        testButton = view.findViewById(R.id.btn_test_printer);
        testButton.setOnClickListener(v -> testPrinter(getString(R.string.app_name_)));
    ...
    private void testPrinter(String appName) {
        SmartPrinter.with(getActivity(), mPrinterName).printTest(appName);
    }
